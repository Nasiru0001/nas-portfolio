...
const TechStack = () => {
  return (
    ...
    <div className="md:mx-40 rounded-2xl flex flex-col justify-center items-center py-20 ">
        ...
        <div className="flex md:gap-5 gap-1 ml-4">

            <div className="border-4 border-slate-900 bg-slate-900 md:p-5 p-2 rounded-2xl">
                <svg viewBox="0 0 128 128" className="md:w-25 w-10">
            ...
            <div className="flex md:gap-5 gap-2 md:mx-20 mx-10">
        ...
        <div className="flex justify-center gap-5">
            ...
            <div className="border-4 border-slate-900 bg-slate-900 md:p-5 p-2 rounded-2xl">
             ...
             <div className="border-4 border-slate-900 bg-slate-900 md:p-5 p-2 rounded-2xl">
               <Image src="/foundry.png" alt="Foundry"  width={100} height={100} className='md:w-25 w-10' />
            </div>
