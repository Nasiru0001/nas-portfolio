...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-4 left-1/2 -translate-x-1/2 z-50 w-[90%] md:w-auto overflow-x-auto">
      <div className="flex items-center justify-center mx-auto md:px-7 px-7 py-4 bg-slate-900/60 backdrop-blur-md text-white md:space-x-7 space-x-3 mt-2 rounded-full">
